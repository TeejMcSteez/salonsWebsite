<div class="dark:bg-slate-900 overflow-auto">
    ...
    <main class="container mx-auto px-6">
        <section id="services" class="my-12 p-6 bg-white dark:bg-slate-800 dark:text-gray-100 rounded-lg shadow-md">
            ...
            <div id="extensions" class="mb-6">
                ...
                <ul class="list-disc ml-6 mt-2">
                    <li class="text-gray-700 dark:text-gray-200 font-medium">$150+</li>
                </ul>
            </div>
        ...
        <section id="policies" class="my-12 p-6 bg-white rounded-lg shadow-md dark:bg-slate-800 dark:text-gray-100">
