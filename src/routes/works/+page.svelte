<script>
    ...
    /**
     * @type {{ img: string, category: string, title: string, description: string } | null}
     */
    let selectedImage = null;
    /**
     * 
     * @param {{ img: string, category: string, title: string, description: string }} work
     */
